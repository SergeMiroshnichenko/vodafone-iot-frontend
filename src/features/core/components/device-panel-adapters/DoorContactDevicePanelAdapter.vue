...
import doorClosedImage from '../../assets/device-roles/door-contact-lg-close.svg';
...
export default class DoorContactDevicePanelAdapter extends Mixins(DeviceRoleMapMixin, MetricMapMixin) {
  @ObjectProp(true)
  ...
  private get backgroundImage(): string {
    ...
    const { lg, md } = this.deviceRoleMap.DOOR_CONTACT.icons;
