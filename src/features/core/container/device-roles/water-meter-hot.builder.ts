...
import lg from '@core/assets/device-roles/water-meter-hot-lg.svg';
import md from '@core/assets/device-roles/water-meter-hot-md.svg';
import sm from '@core/assets/device-roles/water-meter-hot-sm.svg';
import component from '@core/components/device-panel-adapters/WaterMeterHotDevicePanelAdapter.vue';
import moment from 'moment';
import { DEVICE_ROLES } from '..';

export default option(DEVICE_ROLES, async () => ({
  name: 'WATER_METER_HOT',
