...
import lg from './electricity-meter-analog-lg.svg';
import md from './electricity-meter-analog-md.svg';
import sm from './electricity-meter-analog-sm.svg';
import component from './ElectricityMeterAnalogDevicePanelAdapter.vue';

export default option(DEVICE_ROLES, async () => ({
  name: 'ELECTRICITY_METER_ANALOG',
  label: 'Stromzähler (analog)',
  shortLabel: 'Strom',
  icons: { sm, md, lg },
  component,
  formatValue,
