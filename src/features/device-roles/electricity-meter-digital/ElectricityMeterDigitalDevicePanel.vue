<template lang="pug">
  device-panel(v-bind="$attrs" :background-image="electricityMeterDigitalLg")
    template(#actions)
      slot(name="actions")
    template(#properties)
...
import electricityMeterDigitalLg from './electricity-meter-digital-lg.svg';

@Component({ components: { DevicePanel, Counter } })
export default class ElectricityMeterDigitalDevicePanel extends Vue {
  @NumberProp()
  ...
  private readonly electricityMeterDigitalLg = electricityMeterDigitalLg;
}
</script>
